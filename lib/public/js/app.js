...
FMApp.config(function($sceProvider) {
  ...
  function ($scope, $http, $location) {
    ...
    FM.clickFile = function (file) {
      if (file.folder) {
        ...
        // download file
        console.log('/video/'+FM.curFolderPath+file.relPath);
        if(FM.curFolderPath==='/'){
          FM.videoURL='http://192.168.1.17:8000/video'+file.relPath;
        }else{
          FM.videoURL='http://192.168.1.17:8000/video'+FM.curFolderPath+file.relPath;
        }
        // downloadFile(file);
      }
    };
